...
export const Header = () => {
    ...
    return <header className={`${styles['header-main']} pt-3 px-4`}>
            ...
            <div className="flex items-center justify-between mx-auto p-4">
                ...
                <div className="w-1/5 flex items-center justify-end md:order-2"> {/**MENU */}
                    <button type="button" className="flex mr-3 text-sm bg-gray-800 rounded-full md:mr-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
                        ...
                        <img alt="" className='rounded-full' src="https://miro.medium.com/v2/resize:fill:40:40/1*dmbNkD5D-u45r44go_cf0g.png" width="32" height="32" />
                    </button>
