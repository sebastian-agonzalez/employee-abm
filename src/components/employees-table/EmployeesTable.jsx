    ...
    employees && (
      <HorizontalRouteAnimator className={""}>
        <div className="relative overflow-x-auto shadow-md sm:rounded-lg mx-8">
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400 lg:table-fixed ">
            <thead className="bg-gradient-to-r from-blue-500 to-pink-700 bg-opacity-10 text-xs text-white uppercase">
              <tr>
                <th scope="col" className="px-10 py-3 lg:w-1/6">
                  Registration Status
                </th>
                ...
                <th scope="col" className="px-6 py-3 lg:w-1/6">
                  Begin Data
                </th>
                <th scope="col" className="px-6 py-3 ">
                  End Date
                    ...
                    <td className={"px-6 py-3 "}>
                      <span>
                        <div className="flex justify-start items-center">
                          ...
                          <span
                            className={
                              "mx-3 rounded-full inline-block p-1 bg-" +
